...
public class UpdateItemHandler(IItemRepository itemRepository, IValidator<UpdateItemCommand> validator, IUnitOfWork unitOfWork) : ICommandHandler<UpdateItemCommand>
{
